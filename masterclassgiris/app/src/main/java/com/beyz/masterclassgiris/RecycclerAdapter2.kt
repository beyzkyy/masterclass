...
class RecyclerAdapter2(val ogrenciisimlist : ArrayList<String>) : RecyclerView.Adapter<RecyclerAdapter2.OgrenciListesiVH>(){
    ...
    override fun onBindViewHolder(holder: OgrenciListesiVH, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context,yoneticiekran3::class.java)
